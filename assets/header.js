...
window.Modernizr = function(e, t, n) {
    ...
    function f(e, t, r) {
        for (var s in e) {
            var i = t[e[s]];
            if (i !== n) return r === !1 ? e[s] : o(i, "function") ? i.bind(r || t) : i
        }
        return !1
    }
    ...
    function u(e, t, n) {
        ...
        return o(t, "string") || o(t, "undefined") ? i(s, t) : (s = (e + " " + T.join(r + " ") + r).split(" "), f(s, t, n))
    }
    var c, a, l, p = "2.8.2",
        d = {},
        m = !0,
        ...
        z = C.slice,
        E = function(e, n, r, o) {
            var s, i, f, u, c = t.createElement("div"),
                a = t.body,
                l = a || t.createElement("body");
            if (parseInt(r, 10))
                for (; r--;) f = t.createElement("div"), f.id = o ? o[r] : v + (r + 1), c.appendChild(f);
            return s = ["&#173;", '<style id="s', v, '">', e, "</style>"].join(""), c.id = v, (a ? c : l).innerHTML += s, l.appendChild(c), a || (l.style.background = "", l.style.overflow = "hidden", u = y.style.overflow, y.style.overflow = "hidden", y.appendChild(l)), i = n(c, e), a ? c.parentNode.removeChild(c) : (l.parentNode.removeChild(l), y.style.overflow = u), !!i
        },
        P = {}.hasOwnProperty;
    l = o(P, "undefined") || o(P.call, "undefined") ? function(e, t) {
        ...
        var n = z.call(arguments, 1),
            r = function() {
                if (this instanceof r) {
                    ...
                    var s = new o,
                        i = t.apply(s, n.concat(z.call(arguments)));
        ...
        var n;
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : E(["@media (", b.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
            n = 9 === e.offsetTop
        }), n
        ...
        var e = !!u("perspective");
        return e && "webkitPerspective" in y.style && E("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t, n) {
    ...
    for (var k in g) l(g, k) && (a = k.toLowerCase(), d[a] = g[k](), C.push((d[a] ? "" : "no-") + a));
    return d.addTest = function(e, t) {
        if ("object" == typeof e)
            for (var r in e) l(e, r) && d.addTest(r, e[r]);
        else {
            if (e = e.toLowerCase(), d[e] !== n) return d;
            t = "function" == typeof t ? t() : t, "undefined" != typeof m && m && (y.className += " supports-" + (t ? "" : "no-") + e), d[e] = t
        }
        return d
    }, r(""), h = c = null, d._version = p, d._prefixes = b, d._domPrefixes = T, d._cssomPrefixes = j, d.testProp = function(e) {
        return i([e])
    }, d.testAllProps = u, d.testStyles = E, y.className = y.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (m ? " supports-js supports-" + C.join(" supports-") : ""), d
}(this, this.document);
