...
$(document).ready(function(){
    ...
    /// Live search
    var preLoadLoadGif = $('<img src="//cdn.shopify.com/s/files/1/0444/3697/9863/t/20/assets/loading.gif?v=59298858641935613281654575378" />');
    ...
    $('.ajaxsearch, .search-bar__form').on('submit', function(e){
      e.preventDefault();
      var term = '*' + $(this).find('input[name="q"]').val() + '*';
      var linkURL =  'search?type=product&q=' + term; //$(this).attr('action') + 'search?type=product&q=' + term;
