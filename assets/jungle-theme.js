 ...
 // (c) Copyright 2014 Caroline Schnapp. All Rights Reserved. Contact: mllegeorgesand@gmail.com
    ...
    var t = {
      ...
      headerToggle: function() {      
        e(".header-account_links ul").on("click", ".init", function() {
          e(this).closest(".header-account_links ul").children('li:not(.init)').toggle();
        });

        var allOptions = e(".header-account_links ul").children('li:not(.init)');
        e(".header-account_links ul").on("click", "li:not(.init)", function() {
          allOptions.removeClass('selected');
          e(this).addClass('selected');
          e(".header-account_links ul").children('.init').html(e(this).html());
          allOptions.toggle();
        });
		t.activeArrow();
      },
      headerallCollections: function() {     
        e(".header-all--collections ul").on("click", ".init", function() {
          e(this).closest(".header-all--collections ul").children('li:not(.init)').toggle();
        });

        var allOptions = e(".header-all--collections ul").children('li:not(.init)');
        e(".header-all--collections ul").on("click", "li:not(.init)", function() {
          allOptions.removeClass('selected');
          e(this).addClass('selected');
          e(".header-all--collections ul").children('.init').html(e(this).html());
          allOptions.toggle();
        });
       t.activeArrow();
      ...
      e('.init').click(function() {
       ...
       addEventLookbookModal: function () {
           // body.off('click.addEvenLookbookModal touchstart.addEvenLookbookModal', '[data-lookbook-icon]').on('click.addEvenLookbookModal touchstart.addEvenLookbookModal', '[data-lookbook-icon]', function (event) {
            e( '[data-lookbook-icon]' ).on('click', function(event) {
              event.preventDefault();
                event.stopPropagation();

                var handle = e(this).data('handle'),
                    position = e(this);
				
                t.doAjaxAddLookbookModal(handle, position);	
               e( '[data-close-lookbook-modal], .ajax-lookbook-modal .overlay'  ).on('click', function() {
                //doc.off('click.closeLookbookModal').on('click.closeLookbookModal', '[data-close-lookbook-modal], .ajax-lookbook-modal .overlay', function () {
                    t.closeLookbookModal();
                    return false;
                });
            });
        },
      doAjaxAddLookbookModal: function (handle, position) {
        var offSet = e(position).offset(),
            top = offSet.top,
            left = offSet.left,
            iconWidth = position.innerWidth(),
            innerLookbookModal = e('.ajax-lookbook-modal').innerWidth(),
            str3 = iconWidth + "px",
        ...
        e.ajax({
          ...
          success: function (data) {
            e('.ajax-lookbook-modal').css({
              'left': newleft,
              'top': newtop
            });

            e('.ajax-lookbook-modal .lookbook-content').html(data);

            e('.ajax-lookbook-modal').fadeIn(500);
          },

          error: function (xhr, text) {
            e('.ajax-error-message').text(e.parseJSON(xhr.responseText).description);
        ...
        e(".ajax-lookbook-modal").fadeOut(500);
      },
          
      videoPlay: function() { 
        if ( e( '.p-video' ).length > 0 ) {
          e( '.jas-popup-url' ).magnificPopup({
            disableOn: 0,
      ...
      sizeChart: function() {
        var sizeChart_class = e('.size-chart-open-popup');
        if ( sizeChart_class.length ) {
          e(sizeChart_class).magnificPopup({
            mainClass: 'mfp-fade',
             removalDelay: 300,
            type:'inline',
            midClick: true
      ...
      headerAlter: function() { 
        var header_13 = e('.header-type-13');       
        if ( header_13.length ) {          
          e( '.nav-menu-icon' ).on('click', function() {
            e('.menu-item-depth-0').each(function(i){
              var menuitem = $(this);
              setTimeout(function() {
                menuitem.toggleClass('menu-item-show');
              }, 100*i);
            });
            e(this).find('span').each(function(i){
              var iconitem = $(this);
              setTimeout(function() {
                iconitem.toggleClass('animate-icon');
              }, 100*i);	
            });
            e('.nav-bar-mobile').toggleClass('nav-show');
          });    
        }
      },
      ...
      product_gallery: function() { 
        var product_gallery = e( '.product_gallery' );        
        if ( product_gallery.length ) {
          e(product_gallery).not('.slick-initialized').slick({ 
            slidesToShow: 1,
            dots: false,
            arrows: true
          });
      ...
      initHeaderSticky: function(){
       /*
        if(window.use_sticky){
          ...
          e(".header-sticky").sticky({topSpacing:0, zIndex: '999'});
  ...
  var sticky = e('.navigation-bar-sticky'),
    scroll = e(window).scrollTop();
   
  if (scroll >= 350) { 
    sticky.addClass('is-sticky-custom'); }
  else { 
   sticky.removeClass('is-sticky-custom');
      ...
      initNewsLetterPopup: function() {
            if (window.newsletter_popup) {
                var k = e("[data-newsletter]"), closebtn = k.find(".close-popup"), i = k.find(".form-content");
                modalContent = k.find(".ajax-popup-text"), "closed" != e.cookie("entry-popup-modal") && (t.setTimeout = setTimeout(function() {
                ...
                }), e("#entry-popup-form form").submit(function() {
                    "" != e("#entry-popup-form .mail").val() && t.closeEmailModalWindow(k)
                     e(".entry-popup-success-modal").find(".ajax-popup-text").show();
                     t.showModal(".entry-popup-modal");
      ...
      openEmailModalWindow: function(t) {
             e('.entry-popup-main').fadeIn(500)
        },
       closeEmailModalWindow: function(t) {
            e('.entry-popup-main').fadeOut(500),
            e.cookie("entry-popup-modal", "closed", {
              //  expires: 1,
                path: "/"
            })
        },
initMobileMenu: function() {
      ...
      initShortcode: function() {
       e('.theme-toggle').toggle(function(){ e(this).addClass('active'); },function(){ e(this).removeClass('active'); });
	   e('.theme-toggle').click(function(){ e(this).next('.theme-toggle-content').slideToggle(); });
	   e('.theme-toggle-frame-set').each(function(){
		var $this = e(this),
		$toggle = $this.find('.theme-toggle-accordion');
		
		$toggle.click(function(){
			if( e(this).next().is(':hidden') ) {
				$this.find('.theme-toggle-accordion').removeClass('active').next().slideUp();
		...
		$this.find('.theme-toggle-accordion:first').addClass("active");
		$this.find('.theme-toggle-accordion:first').next().slideDown();
	});/* Toggle Shortcode end*/
    
    //TABS...
	if(e('ul.tabs').length > 0) {
	  e('ul.tabs').tabs('> .theme-tabs_content');
	}
	
	if(e('ul.theme-tabs-frame').length > 0){
	e('ul.theme-tabs-frame').tabs('> .theme-tabs-frame-content');
	}
	...
	if(e('.theme-tabs').length > 0) {
		e('.theme-tabs').tabs('> .theme-tabs-content');
	}
  
	if(e('.theme-tabs-vertical-frame').length > 0){
	
		e('.theme-tabs-vertical-frame').tabs('> .theme-tabs-vertical-frame-content');
		
		e('.theme-tabs-vertical-frame').each(function(){
			e(this).find("li:first").addClass('first').addClass('current');
			e(this).find("li:last").addClass('last');
		});
		
		e('.theme-tabs-vertical-frame li').click(function(){
      ...
      initProductMoreview: function() {
       ...
       e(".more-view-wrapper-owlslider ul").owlCarousel({
            ...
            margin:10,
            nav:true,
            navContainer: ".product-template-owl-carousel",
            navText: ['<a class="prev"><i class="fa fa-chevron-left"></i></a>','<a class="next"><i class="fa fa-chevron-right"></i></a>'],
            dots: false,
            responsive:{
                0:{
                    items:3
        ...
        initProductWishlist: function() {
            e(".product-template-wrapper button.wishlist").click(function(n) {
                n.preventDefault();
                var r = e(this).parent();
                ...
                e.ajax({
                    ...
                    success: function(n) {
                       ...
                       var wp = e(".product-template_title").text();
                       var wamt = e(".product-template_price .grid-link__org_price span.money").text();   
            ...
            e("#slidedown-cart .btn-remove").click(function(n) {
                ...
                Shopify.removeItem(r, function(e) {
                    t.doUpdateDropdownCart(e);
                  	t.doUpdateDropdownCartSticky(e)
                })
            })
        },
                    ...
                    if (e(this).attr("disabled") != "disabled") {
                        if (!window.ajax_cart) {
                          ...
                          var o = e("#product-featured-image").attr("src");
                            ...
                            var p = e(".product-template_title").text();
                            var amt = e(".product-template_price .grid-link__org_price span.money").text();   
   ...
   initThumbchange: function() {
      ...
      updatePricingQuickview: function() {
        ...
        doUpdateDropdownCart: function(n) {
            var r = '<li class="item" id="cart-item-{ID}"><a href="{URL}" title="{TITLE}" class="product-image"><img src="{IMAGE}" alt="{TITLE}"></a><div class="product-details"><a href="javascript:void(0)" title="Remove This Item" class="btn-remove"><span class="material-icons">close</span></a><p class="product-name"><a href="{URL}">{TITLE}</a></p><div class="cart-collateral">{QUANTITY} x <span class="price">{PRICE}</span></div></div></li>';
          ...
          e(".ajax-success-modal").find(".ajax_cartTotal").html(Shopify.formatMoney(n.total_price, window.money_format));
            e("#minicart_total").html(Shopify.formatMoney(n.total_price, window.money_format));
       ...
       sidebarMapView: function() {
         var listIcon = e('a.list');
         var gridIcon = e('a.grid');
         var initWrapper = e('div.collection-boxed');
         listIcon.on('click',function(){
           gridIcon.removeClass('show-it');
           listIcon.addClass('show-it');
           initWrapper.removeClass('collection-boxed').addClass('collection-list');
           t.sidebarAjaxClick();      

         });

         gridIcon.on('click',function(){
           listIcon.removeClass('show-it');
           gridIcon.addClass('show-it');
           initWrapper.removeClass('collection-list').addClass('collection-boxed');
           t.sidebarAjaxClick();      
      ...
      sidebarMapShow: function() {
       ...
       initSortby: function() {
        ...
        sidebarMapPaging: function() {
            e(".pagination a").click(function(n) {
       ...
       sidebarMapTagEvents: function() {
        ...
        sidebarInitToggle: function() {
            if (e(".filter").length > 0) {
                e(".filter .widget h4 span").click(function() {
                    ...
                    e(this).parents(".filter").find(".widget-content").slideToggle();
                });
            }
        },
       
        footerToggle: function() {
            var footerTitle = $('.theme-footer .dropdow-mb');
...
//view mode and show filter
        ...
        sidebarMapData: function(data) {
          var currenttype = e(".productCover .product-for-loop");           
          var currentList = e(data).find(".productCover .product-for-loop");                     
          currenttype.replaceWith(currentList);
          //convert currency
            if (t.checkNeedToConvertCurrency()) {
                Currency.convertAll(window.shop_currency, jQuery('#currencies').val(), '.productCover span.money', 'money_format');
            }
          ...
          //replace paging
            if (e(".padding").length > 0) {
                ...
                e(".grid-link__container.productCover").append(e(data).find(".padding"));
            }
       ...
       initInfiniteScrolling: function() {
        ...
        doInfiniteScrolling: function() {
            var currentList = $('.productCover .product-for-loop');
            if (currentList) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        t.hideLoading();
                        var products = $(data).find(".productCover .products-boxed-view");
                        if (products.length) {
  ...
  e(document).on('click', '.remove-compare', function(event) {
      ...
      storage.set('compare', compare);       
     var rmtd = e('#table-compare tr td');
    rmtd.length ? ' ' : e('#moda-compare').fadeOut(600);
    });

    /** End compare */
    
  },//Added custom
      initDropDownCartSticky: function() {
            if (window.dropdowncart_type == "click") {
                e("#ToggleDownSticky").click(function() {
                    if (e("#slidedown-cart-sticky").is(":visible")) {
                        e("#slidedown-cart-sticky").slideUp("fast")
                    } else {
                        e("#slidedown-cart-sticky").slideDown("fast")
                    }
                })
            } else {
                if (!("ontouchstart" in document)) {
                    e("#ToggleDownSticky").hover(function() {
                        if (!e("#slidedown-cart-sticky").is(":visible")) {
                            e("#slidedown-cart-sticky").slideDown("fast")
                        }
                    });
                    e(".wrapper-top-cart-sticky").mouseleave(function() {
                        e("#slidedown-cart-sticky").slideUp("fast")
                    })
                } else {
                    e("#ToggleDownSticky").click(function() {
            ...
            t.checkItemsInDropdownCartSticky();
            e("#slidedown-cart-sticky .no-items a").click(function() {
                e("#slidedown-cart-sticky").slideUp("fast")
            });
            e("#slidedown-cart-sticky .btn-remove").click(function(n) {
                n.preventDefault();
                var r = e(this).parents(".item").attr("id");
                r = r.match(/\d+/g);
                Shopify.removeItem(r, function(e) {
      ...
      checkItemsInDropdownCartSticky: function() {
            if (e("#slidedown-cart-sticky .mini-products-list").children().length > 0) {
                e("#slidedown-cart-sticky .no-items").hide();
                e("#slidedown-cart-sticky .has-items").show()
            } else {
                e("#slidedown-cart-sticky .has-items").hide();
                e("#slidedown-cart-sticky .no-items").show()
            }
        },
      updateDropdownCartSticky: function() {
            Shopify.getCart(function(e) {
                t.doUpdateDropdownCartSticky(e)
            })
        },
      doUpdateDropdownCartSticky: function(n) {
            var r = '<li class="item" id="cart-item-{ID}"><a href="{URL}" title="{TITLE}" class="product-image"><img src="{IMAGE}" alt="{TITLE}"></a><div class="product-details"><a href="javascript:void(0)" title="Remove This Item" class="btn-remove"><span class="material-icons">close</span></a><p class="product-name"><a href="{URL}">{TITLE}</a></p><div class="cart-collateral">{QUANTITY} x <span class="price">{PRICE}</span></div></div></li>';
          e("#cartCountSticky").text(n.item_count );
          e(".ajax-success-modal").find(".ajax_cartCount").text(n.item_count );
          e(".ajax-success-modal").find(".ajax_cartTotal").html(Shopify.formatMoney(n.total_price, window.money_format));
            e("#minicart_total_sticky").html(Shopify.formatMoney(n.total_price, window.money_format));
            e("#slidedown-cart-sticky .summary .price").html(Shopify.formatMoney(n.total_price, window.money_format));
            e("#slidedown-cart-sticky .mini-products-list").html("");
            if (n.item_count > 0) {
                for (var i = 0; i < n.items.length; i++) {
                    var s = r;
                    s = s.replace(/\{ID\}/g, n.items[i].id);
                    ...
                    s = s.replace(/\{IMAGE\}/g, Shopify.resizeImage(n.items[i].image, "small"));
                    s = s.replace(/\{PRICE\}/g, Shopify.formatMoney(n.items[i].price, window.money_format));
                    e("#slidedown-cart-sticky .mini-products-list").append(s)
                }
                e("#slidedown-cart-sticky .btn-remove").click(function(n) {
                    n.preventDefault();
                    var r = e(this).parents(".item").attr("id");
                ...
                if (t.checkNeedToConvertCurrency()) {
                    Currency.convertAll(window.shop_currency, jQuery('#currencies').val(), '#slidedown-cart-sticky span.money', 'money_format')
                    Currency.convertAll(window.shop_currency, jQuery('#currencies').val(), '#minicart_total_sticky span.money', 'money_format')
                    Currency.convertAll(window.shop_currency, jQuery('#currencies').val(), '.ajax_cartTotal span.money', 'money_format')
